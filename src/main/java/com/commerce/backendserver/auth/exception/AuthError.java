...
public enum AuthError implements ErrorCode {
	...
	GOOGLE_OAUTH_ERROR("구글 서버 통신간 오류입니다.", INTERNAL_SERVER_ERROR, "A_004"),
	KAKAO_OAUTH_ERROR("카카오 서버 통신간 오류입니다.", INTERNAL_SERVER_ERROR, "A_005"),

	REDIRECT_ERROR("리다이렉트간 에러입니다.", INTERNAL_SERVER_ERROR, "A_006");
